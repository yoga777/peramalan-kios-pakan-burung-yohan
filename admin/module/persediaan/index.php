							...
							<table class="table table-bordered" id="example1">
								...
								?>
									<tr>
										...
										<td>
											<?php if($isi['stok'] <= '20'){?>
												<h4 style="background-color: red;">Stok tidak aman</h4>
											<?php }else{?>
												<h4 style="background-color: blue;">Stok aman</h4>
											<?php }?>
										</td>
										<td>
											...
											<?php }else{?>
											<a href="index.php?page=persediaan/details&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-primary">Details</button></a>
											<a href="index.php?page=persediaan/edit&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-warning">Edit</button></a>
								...
								<div class="box-content">
									<table class="table table-striped bordered">
										<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
											...
											<tr>
												<td>Detail Barang</td>
												<td><input type="text" placeholder="Detail Barang" class="form-control"  name="merk"></td>
											</tr>
											<tr>
												<td>Harga Beli</td>
